...
adb push libs/arm64-v8a/libmerge.so /sdcard/Android/data/com.beatgames.beatsaber/files/mods/libmerge.so
adb shell am force-stop com.beatgames.beatsaber


# Run lldb-server in the background
# adb push android-studio/plugins/android-ndk/resources/lldb/android/arm64-v8a/lldb-server /data/local/tmp/lldb-server
...
# Start game
adb shell am start -D com.beatgames.beatsaber/com.unity3d.player.UnityPlayerActivity
